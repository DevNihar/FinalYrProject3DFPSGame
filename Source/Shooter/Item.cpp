...
void AItem::StartItemCurve(AShooterCharacter* Char, bool bForcePlaySound)
{
	...
	Character = Char;
	// Get array index in InterpLocations Array with lowest Item Count
	...
	// Sets the start location of the current item
	...
	// The Initial Yaw Offset between Camera and Item
...
void AItem::FinishInterping()
{
	...
	if(Character)
	{
		// Substract 1 from the item count of the interp locatipn struct
		Character->IncrementInterpLocItemCount(InterpLocIndex, -1);
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	{
		// Elapsed time since we started the ItemInterpTimer 
		...
		// Adding curve value to the initial location of the Item (scaled by deltaz)
		ItemLocation.Z += CurveValue * DeltaZ;
		SetActorLocation(ItemLocation, true, nullptr, ETeleportType::TeleportPhysics);
		// Camera Rotation this frame
		const FRotator CameraRotation{Character->GetFollowCamera()->GetComponentRotation()};
		// Camera Rotation + initialYawOffset
...
void AItem::BeginPlay()
{
	...
	// setting the Tchar array of bools corresponding to the rarity of thw item
	SetActiveStars();
...
void AItem::Tick(float DeltaTime)
{
	...
	// handle ItemInteroing when in EquipInterping State
